...
class ManejadorHTML:
    ...
    def guardar_como_html(self):
        file_path = filedialog.asksaveasfile(defaultextension=".html", filetypes=[("Archivos HTML","*.html"),("Todos los Archivos","*.*")])
    ...
    def abrir_archivo(self):
        file_path = filedialog.askopenfile(defaultextension=".html", filetypes=[("Archivos HTML","*.html"),("Todos los Archivos","*.*")])
